				...
				<footer class="sticky-footer">
					<div class="container my-auto">
						<div class="copyright text-center my-auto">
							<span><?php echo date('Y'); ?> &copy; Sarah Herbst</span>
						</div>
					</div>
				</footer>
			...
			<div class='modal-dialog' role='document'>
				<div class='modal-content'>
					<div class='modal-header'>
						<h5 class='modal-title' id='logoutModalLabel'>Bereit zum Ausloggen?</h5>
		...
		<script type="text/javascript" src="js/jquery.character-counter.js" defer></script>
		...
		<script type="text/JavaScript" src="js/jscolor.js" defer></script>
