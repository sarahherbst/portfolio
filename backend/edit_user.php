<?php
	...
	if (isset($_POST['speichern'])) {
		...
		if ($use_passwort !== '' AND $use_passwort == $pw_wiederholung) {
			...
			$pw_update	= sql_update('user', 'use_passwort', $pw_md5, 'use_id', $use_id);
			if ($pw_update == true) {
				$fehlerangabe 	.= '<div class="alert alert-success" role="alert">Das Passwort wurde erfolgreich geändert. '.$use_passwort.' '.$pw_md5.'</div>';
			} else {
				$fehler++;
		...
		if ($fehler == 0) {
			$user_update = sql_update('user', array('use_vorname', 'use_nachname', 'use_position', 'use_strasse', 'use_plz', 'use_ort', 'use_tel', 'use_email', 'chg_user'), array($use_vorname, $use_nachname, $use_position, $use_strasse, $use_plz, $use_ort, $use_tel, $use_email, $user_email), 'use_id', $use_id);
			if ($user_update == true) {
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="use_strasse" id="use_strasse" placeholder="Straße" value="<?php echo $use_strasse; ?>">
							</div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="use_plz" id="use_plz" placeholder="PLZ" value="<?php echo $use_plz; ?>">
									</div>
								</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="use_tel" id="use_tel" placeholder="Telefon" value="<?php echo $use_tel; ?>">
							</div>
						</div>
					</div>
